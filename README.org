...
I normally have 2 emacs instances running, one for each context. I got the idea from https://tychoish.com/post/running-emacs/ I

#+begin_src shell
cp etc/emacs@.service ~/.config/systemd/user/
cp etc/emacs-personal.desktop ~/.local/share/applications
cp etc/emacs-personal.desktop ~/.local/share/applications
